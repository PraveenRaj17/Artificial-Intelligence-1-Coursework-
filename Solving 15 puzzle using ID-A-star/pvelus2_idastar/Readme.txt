"Iterative deepening A-Star search" to find a solution for the 15-puzzle using two types of heuristics
...
The program displays a menu to choose the type of heuristic - Manhattan distance. Number of misplaced tiles or both.

Upon choosing the heuristic, the program gives the following information in the output for both heuristics in the below format:
